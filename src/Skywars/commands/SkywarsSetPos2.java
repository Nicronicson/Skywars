...
public class SkywarsSetPos2 implements CommandExecutor {
    @Override
        ...
        if (commandSender instanceof Player) {
            ...
            if(strings.length == 0) {
                ...
                if(Mapbuilder.getPlayer() != null && Mapbuilder.getPlayer() == player){
                    Mapbuilder.getMap().setPos2(player.getLocation().getBlockX(), player.getLocation().getBlockY(), player.getLocation().getBlockZ());
